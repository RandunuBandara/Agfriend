...
<html>
    <head>
        <title>transportOwner_form</title>
        ...
        <div class="Customer_details">
            <form>
                ...
                <div class="title_details" >
                    <h2>Transport Service Owner's Personal Details</h2>
                    <hr>
                </div>
                ...
                <div class="billingAddress" >
                    <div class="billingDetails">
                        <span style=" display: flex;">
                            <input class="form_textbox" size="50" type="text" id="st01" placeholder="Vehicle number" name="add_line1">
                        </span>
                        <span style=" display: flex;">
                            <input size="50" class="form_textbox" type="text" id="st02" placeholder="Vehicle type" name="add_line2">
                        </span>
                        <br><br>
                    </div>
                </div>
