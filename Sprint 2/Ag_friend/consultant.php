        ...
        <div class="Customer_details">
            <form action=" signup.inc.php" method="POST">
                <div class="title_details" >
                    <h2>Consaltant Personal Details</h2>
                    <hr>
                </div>
                <div class="details">
                    <div class="name_details">
                        ...
                        <span style=" display: flex;">
                            <input class="form_textbox"  placeholder="Facebook Name" id="FacebookName " type="text" name="FacebookName" >
                        </span>
                        <span style=" display: flex;">
                    ...
                    <div class="addressDetails">
                        ...
                        <span style="display: flex;">
                         ...
                         <span id="spni" style="vertical-align: top;">
                            <select id="country_select" class="form_dropdown" width="22" name="dis">
                ...
                <div class="proceed_button">
                    <button  type="submit" name="submit"  id="btn01">sign up</button>
                </div>
            </form>
        </div>
        <br>
